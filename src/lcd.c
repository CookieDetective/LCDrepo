...
#define CS_HIGH do { GPIOB->BSRR = GPIO_BSRR_BS_11; } while(0)
#define CS_LOW do { GPIOB->BSRR = GPIO_BSRR_BR_11; } while(0)
#define RESET_NUM 12
#define RESET_BIT (1<<RESET_NUM)
#define RESET_HIGH do { GPIOB->BSRR = GPIO_BSRR_BS_12; } while(0)
#define RESET_LOW  do { GPIOB->BSRR = GPIO_BSRR_BR_12; } while(0)
#define DC_NUM 10
...
#define CSPORT GPIOB
#define LCD_CS    11 /* also known as NSS */
#define RSPORT GPIOA
#define LCD_RS    10
